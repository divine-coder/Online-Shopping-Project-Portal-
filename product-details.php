...
<?php } ?>
									...
									<div class="col-sm-6">
										<div class="favorite-button-23 m-t-10">
											<a class="btn btn-pmary" data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
							...
							<div class="quantity-container-0 info-container">
								<div class="row">
...
?>
										...
										<div class="product-add-reviewers">
...
<textarea class="form-control txt txt-review1" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
																</div><!-- /.form-group -->
															</div>
														</div><!-- /.row -->
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="product-details.php1?pid=<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['productName']);?></a></h3>
			<div class="rating rateit-small"></div>
			...
			<div class="product-price">	
				<span class="price">
					Rs.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discountss">Rs.
...
<?php include('includes/footer.php');?>
    ...
    <script src="assets/js/bootstrap-select.min.js1"></script>
